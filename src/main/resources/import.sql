/* Populate tables */
/*VEHICULOS*/
INSERT INTO vehiculos (id, dominio, tipo_vehic, marca_vehic, desc_vehic, create_at) VALUES(1, 'PAD718', 'AUTO', 'CHEVROLET', 'SEDAN 3 PUERTAS', '2018-01-20');
INSERT INTO vehiculos (id, dominio, tipo_vehic, marca_vehic, desc_vehic, create_at) VALUES(2, 'SUM722', 'CAMIONETA', 'VOLVO', 'UTILITARIO 2 EJES', '2018-02-05');
INSERT INTO vehiculos (id, dominio, tipo_vehic, marca_vehic, desc_vehic, create_at) VALUES(3, 'SND234', 'MOTO', 'BMW', 'MOTO MAS DE 100CC', '2018-02-18');
/*PERSONAS*/
